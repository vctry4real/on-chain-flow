...
function buildMockClusters(token_address, hours) {
        ...
        try {
            ...
            const scoredClusters = rawClusters.map((cluster) => {
                ...
                return {
                    ...
                    timing_variance_minutes: (breakdown.timing_variance * 8).toFixed(1),
            ...
            const result = {
                ...
                narrative: generateAccumulationNarrative('USDC', verdict, topScore, filteredClusters),
...
//# sourceMappingURL=stealth-accumulation.js.map
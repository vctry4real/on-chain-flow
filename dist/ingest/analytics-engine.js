 ...
 */
export function scoreAccumulationCluster(cluster) {
    ...
    const weighted_score = order_size_distribution * w.order_size_distribution +
    ...
    const activity_consistent_with = logistic_probability >= 0.72 ? 'human_coordinated' :
...
export function generateBridgeNarrative(token_symbol, verdict, total_usd, correlated, routes) {

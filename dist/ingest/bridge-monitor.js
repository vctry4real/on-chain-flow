...
async function saveDailySnapshot(chain, tokenAddress) {
...
async function computeRollingBaseline(chain, tokenAddress) {
...
async function monitorToken(token_address, token_symbol, destination_chain, hours) {
    ...
    const baseline = (await computeRollingBaseline(destination_chain, token_address)) ??
